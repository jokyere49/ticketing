...
// the STRIPE_KEY is set as a secret key in the k8s cluster
// for me to be able to run test, it is set an an environment variable on my local computer 
//process.env.STRIPE_KEY = 'some string'
let mongo: any;
...
global.getAuthCookie =  (id?: string) =>{
    // Build  a JWT payload. {id, email}
     const payload ={
        // if id is provide use that for id or
